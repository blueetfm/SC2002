...
public class Patient extends Person implements PatientMenu {
    ...
    public Patient(int hospitalID, String password, String role, String name, Date birthDate, String gender, String phoneNum, String email, int patientID, String bloodType, List<MedicalRecord> medicalHistory){
